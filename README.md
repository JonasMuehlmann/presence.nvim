...
require("presence"):setup({
    ...
    whitelist           = {},                         -- A list of strings or Lua patterns that enable Rich Presence ONLY if the current file name, path, or workspace matches (if using a whitelist, activity is only set for matches)
